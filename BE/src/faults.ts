 ...
 * @returns {Promise<Fault>} Returns the newly created fault.
 */
export async function addFault(fault: Fault): Promise<Fault> {
    const container = getFaultsContainer();
 ...
 * @returns {Promise<Fault>} Returns the updated fault in the database.
 */
export async function updateFault(id: string, category: string, fault: Fault): Promise<Fault> {
    const container = getFaultsContainer();
